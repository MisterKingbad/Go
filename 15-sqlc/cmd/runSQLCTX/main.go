...
func (c *CourseDB) callTx(ctx context.Context, fn func(*db.Queries) error) error {
	...
	if err != nil {
		if errRb := tx.Rollback(); errRb != nil {
			fmt.Errorf("tx error: %v, rb error: %v", err, errRb)
		}
		return err
	}
	return tx.Commit()
...
func main() {
	...
	// 	ID:          uuid.New().String(),
	// 	Name:        "GO",
	// 	Description: sql.NullString{String: "GOOO", Valid: true},
	// 	Price:       10.95,
	// }
	...
	// err = CourseDB.CreateCourseAndCategory(ctx, categoryArgs, coursesArgs)
	// if err != nil {
	// 	panic(err)
	// }
